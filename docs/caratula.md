...
|---------------------|---------------------|--------------|
| 4.c.1 Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software | Paolo Participó en la redacción de la sección Startup Profile y Solution Profile, asegurando que los problemas planteados estuvieran bien fundamentados en fuentes reales y entrevistas. Colaboró en la definición de Lean UX Problem Statements con base en hallazgos objetivos. Fatima Desarrolló las secciones de Needfinding (User Personas, Empathy Mapping, As-is Scenario Mapping) y colaboró en la estructuración del Impact Mapping. Se preocupó por representar adecuadamente a los usuarios objetivo. Marco Encargado de la parte de Product Design (Style Guidelines, Wireframes, Prototyping), cuidando que los lineamientos respeten estándares de accesibilidad y usabilidad. También participó en el Database Design. Romina  Durante esta primera entrega, al realizar el desarrollo del backend para el registro de entrenamientos y ejercicios desde la vista de entrenador, así como el desarrollo del frontend y el diseño UX/UI, se asumió la responsabilidad ética y profesional garantizando la integridad de los datos, la usabilidad de la plataforma y la experiencia de usuario, evitando prácticas que pudieran afectar la confiabilidad o accesibilidad del sistema. | Paolo Demostró responsabilidad profesional al validar que los problemas y necesidades no fueran inventados, sino sustentados en datos. Esto refleja compromiso ético con la veracidad del proyecto. Fatima Reconoció su responsabilidad ética al reflejar fielmente las necesidades reales de los usuarios, evitando sesgos personales. Esto asegura que las soluciones propuestas respondan a problemáticas auténticas. Marco Su trabajo refleja responsabilidad profesional al aplicar buenas prácticas de diseño accesible y seguro, garantizando que la solución no excluya a posibles usuarios con limitaciones técnicas o de accesibilidad. Romina Durante esta primera entrega, al realizar el desarrollo del backend para el registro de entrenamientos y ejercicios desde la vista de entrenador, así como el desarrollo del frontend y el diseño UX/UI, se asumió la responsabilidad ética y profesional garantizando la integridad de los datos, la usabilidad de la plataforma y la experiencia de usuario, evitando prácticas que pudieran afectar la confiabilidad o accesibilidad del sistema.| 
| 4.c.2 Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales | Paolo Analizó a los competidores y definió estrategias para diferenciar la startup frente a ellos (Competitive Analysis y Estrategias/Tácticas). Fátima En la construcción de User Journey Mapping y Impact Mapping, evaluó cómo las decisiones de diseño influyen en la experiencia del usuario y en su bienestar emocional. Marco En la parte de Product Implementation y Database Design, evaluó la escalabilidad y sostenibilidad de la arquitectura, así como la seguridad de la información de los usuarios. Roomina Durante esta primera entrega, al diseñar y desarrollar tanto el backend como el frontend, junto con el diseño UX/UI, se emitieron juicios informados respecto al impacto de la solución, priorizando un diseño accesible y escalable que pueda adaptarse a distintos contextos. Se consideró cómo las decisiones de arquitectura y experiencia de usuario influyen en la eficiencia del sistema, en la facilidad de adopción por parte de los usuarios y en la sostenibilidad de la solución en el tiempo.| Paolo Emitió juicios informados al considerar el impacto económico de la propuesta, garantizando que el producto sea competitivo en el mercado y que las decisiones de negocio sean sostenibles. Fatima Consideró el impacto social de la solución al priorizar la mejora de la calidad de vida de los usuarios, reconociendo que el software debe aportar valor más allá de lo técnico. Marco Emitió juicios informados al considerar el impacto global y social de manejar datos sensibles, asegurando que la solución respete la privacidad y pueda crecer sin comprometer recursos. Romina Durante esta primera entrega, al diseñar y desarrollar tanto el backend como el frontend, junto con el diseño UX/UI, se emitieron juicios informados respecto al impacto de la solución, priorizando un diseño accesible y escalable que pueda adaptarse a distintos contextos. Se consideró cómo las decisiones de arquitectura y experiencia de usuario influyen en la eficiencia del sistema, en la facilidad de adopción por parte de los usuarios y en la sostenibilidad de la solución en el tiempo. |
